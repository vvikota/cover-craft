...
export function ApplicationCard({ text }: ApplicationCardProps) {
  return (
    <div className="flex flex-col justify-between rounded-2xl bg-gray-100 p-5">
      <div className="relative mb-4 overflow-hidden">
        <p className="mb-2 text-sm font-semibold text-gray-800">Dear Stripe team,</p>
        <p className="line-clamp-4 text-sm leading-relaxed text-gray-600">{text}</p>
